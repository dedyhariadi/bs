...
<head>
    ...
    <?php
    echo link_tag('assets/css/bootstrap.min.css', 'stylesheet', 'text/css', 'crossorigin="anonymous"', 'integrity="sha384-LN+7fdVzj6u52u30Kp6M/trliBMCMKTyK833zpbD+pXdCLuTusPj697FH4R/5mcr"');
    ?>
    ...
    echo link_tag('assets/css/style2.css');
    ?>
