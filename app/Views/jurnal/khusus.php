...
<main class="col-md-9 col-lg-10 px-md-4 main-content fs-4">
    ...
    <?= anchor('jurnal', '< back', ['class' => 'link-success link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover fs-4 mb-3']); ?>


    <div class="card mt-3">
        <div class="card-title m-2">
            <div class="align-bottom pt-3 ps-3">
                <h3 class="fs-3 text-uppercase text-primary">KEGIATAN <?= $selectedGiat['kegiatan']; ?></h3>
            </div>
        </div>
        <div class="card-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= form_open_multipart('jurnal/tambah', '', ['giatId' => $selectedGiat['id']]); ?>
                    <div class="mb-3">
    ...
    <div class="modal modal-lg" id="addKegiatanModal" tabindex="-1" aria-labelledby="addKegiatanModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= form_open('jurnal/tambahGiat', '', ['giatId' => $selectedGiat['id']]); ?>
        ...
        <div class="modal modal-lg" id="<?= $modalId; ?>" tabindex="-1" aria-labelledby="editGiatJurnalModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?= form_open('jurnal/editGiat/' . $j['id'], '', ['giatId' => $selectedGiat['id']]); ?>
