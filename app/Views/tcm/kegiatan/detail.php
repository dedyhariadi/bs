...
<main class="col-md-9 col-lg-10 px-md-4 main-content">
              ...
              foreach ($tcm as $item) : ?>
                <tr class="align-middle">
                  ...
                  <td class="text-center">
                    ...
                    <?= form_open('tcm/' . $item['id'], '', ['_method' => 'DELETE', 'jenisGiat' => $kegiatan['jenisGiat'], 'kegiatanId' => $kegiatan['id'], 'trxtcmId' => $item['idTrxTcm']]); ?>
  ...
  <div class="modal modal-lg" id="addTrxTcmModal" tabindex="-1" aria-labelledby="addTrxTcmModal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="addTrxTcmModal">TCM yang berada di <?= array_column($satkai, 'satkai', 'id')[$kegiatan['transferDariId']] ?></h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
